            ...
            class Application {
                static observeVisibility() {
                    if (!Application.dispatchVisibilityChange) {
                        if (globalThis.DotnetExports !== undefined) {
                            Application.dispatchVisibilityChange = globalThis.DotnetExports.UnoUI.Windows.UI.Xaml.Application.DispatchVisibilityChange;
                        }
                        else {
            ...
            class UIElement_Pointers {
                static setPointerEventArgs(pArgs) {
                    if (!Xaml.UIElement._dispatchPointerEventMethod) {
                        if (globalThis.DotnetExports !== undefined) {
                            Xaml.UIElement._dispatchPointerEventMethod = globalThis.DotnetExports.UnoUI.Windows.UI.Xaml.UIElement.OnNativePointerEvent;
                        }
                        else {
                ...
                class FontFamily {
                    ...
                    static notifyFontLoaded(fontFamilyName) {
                        if (!FontFamily.managedNotifyFontLoaded) {
                            if (globalThis.DotnetExports !== undefined) {
                                FontFamily.managedNotifyFontLoaded = globalThis.DotnetExports.UnoUI.Windows.UI.Xaml.Media.FontFamilyLoader.NotifyFontLoaded;
                            }
                            else {
                    ...
                    static notifyFontLoadFailed(fontFamilyName) {
                        if (!FontFamily.managedNotifyFontLoadFailed) {
                            if (globalThis.DotnetExports !== undefined) {
                                FontFamily.managedNotifyFontLoadFailed = globalThis.DotnetExports.UnoUI.Windows.UI.Xaml.Media.FontFamilyLoader.NotifyFontLoadFailed;
                            }
                            else {
